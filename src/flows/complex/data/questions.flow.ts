...
export const questions: IQuestion[] = [
  ...
  },
  {
    ...
    sectionId: 'a0_work',
    subTitle:  "When you work, part of your paycheck goes into Social Security. That's why your work history is a primary consideration.",
  ...
  },
  {
    ...
    sectionId: 'a0_work',
    subTitle:  'Social Security benefits are there for you when your work is impacted for a long period of time.',
  ...
  },
  {
    ...
    title:     'Does your spouse get Social Security checks every month?',
    type:      QUESTION_TYPE.MULTIPLE_CHOICE,
  },
  {
    answers: {
  ...
  },
  {
    ...
    title:     'Do your parent(s) receive Social Security checks every month?',
    type:      QUESTION_TYPE.MULTIPLE_CHOICE,
  },
  {
    answers: {
  ...
  },
  {
    ...
    sectionId: 'a1_disability',
    subTitle:  "Social Security benefits are there for you when the child's daily activities are affected for a long period of time.",
  ...
  },
  {
    ...
    title:     'Do their parent(s) get Social Security checks every month?',
    type:      QUESTION_TYPE.MULTIPLE_CHOICE,
  },
  {
    answers: {
